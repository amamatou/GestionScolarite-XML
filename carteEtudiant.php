                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Carte d'étudiant</h1>
                            <div>
                                <ol class="breadcrumb">
  ...
  <div class="info">
    ...
    <div class="container">
        ...
        <div class="col-xl-6 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Carte d'étudiant de Nouhaila</h5>
                            <form action="generateurPDF/carteNouhaila.php" method="GET">
                                    <input type="submit" class="btn btn-primary" name="sub" value="Generer">
                                </form>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Carte d'étudiant de Haoua</h5>
                            <form action="generateurPDF/carteHaoua.php" method="GET">
                                    <input type="submit" class="btn btn-primary" name="sub" value="Generer">
                                </form>
