                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Affichage des resultats du module GINF31</h1>
                            <div>
                                <ol class="breadcrumb">
  ...
  <?php
          if(isset($_GET['OK']))
          {
            if($_GET['choix']==1)
            {
              ...
              $xsl = new DomDocument;
              $xsl->load('Fichier_xsl/resultats_ing.xsl');
              ...
              $xml_doc->load('Fichiers_xml/Notes_GINF2_Avant.xml');
            ...
            else 
            {
              ...
              // Créer un document DOM et charger les données XML
              $xml_doc = new DomDocument;
              $xml_doc->load('Fichiers_xml/Notes_GINF2_ApresRat.xml');
