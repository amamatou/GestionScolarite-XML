                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Generation d'attestation et/ou de releves de notes</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Pdf</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Attestation & Releves</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="generateurPDF/releve.php" method="GET">
                <label for="cne"><b><font color="green">Entrer le CNE(18000151 à 18000200):</b></font></label>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="generateurPDF/attestation.php" method="GET">
                <label for="cne"><b><font color="green">Entrer le CNE(18000151 à 18000200):</font></b></label>
                <input type="number" id="cne" name="cne"><br><br>
                <input type="submit" class="btn btn-primary" name="sub" value="Generer">
              </form>
            </div>
