    ...
    <div class="container">
      <div class="row align-items-start">
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Affichage resultats/listes de groupes</h5>
              <a href="Affichage.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Mise a jour des donnees/listes de groupes</h5>
              <a href="miseAjour.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Voir des exemples de pdf</h5>
              <a href="miseAjour.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Attestations/Releves de notes</h5>
              <a href="Attestation.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Generation de cartes d'etudiants</h5>
              <a href="carteEtudiant.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Generation du procès verbal</h5>
              <a href="proces.php" class="btn btn-primary">Accéder</a>
            </div>
          </div>
        </div>
