...
require("HTTPPost.php");
    ...
    $query="//Students/Student[CNE="."18000187"."]";
  ...
  $httppost=new HTTPPost();
   $pdfdata=$httppost->post_request("localhost","8087","C://xampp/htdocs/GestionScolaire-XML-final/Fichiers_xslFO/carteHaoua.xsl",$studentXml);

    // save PDF output to a PDF file
    $myFile = "GINF2"."_"."18000187".".pdf";
